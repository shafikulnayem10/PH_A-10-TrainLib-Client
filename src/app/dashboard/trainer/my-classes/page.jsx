...
import { BookOpen, Users, Clock, Plus, RefreshCw, Pencil, Trash2, Eye, Mail, User, DollarSign, Calendar, FileText, Target, Award, Image as ImageIcon } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto my-8 px-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 pb-4 border-b border-blue-100">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-blue-950 tracking-tight">My Managed Classes</h1>
                        <p className="text-blue-500 font-medium text-sm">Update records, delete templates, and track attendees.</p>
                    </div>
                </div>
    ...
    <Plus size={18} /> Add New Class
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center min-h-[400px] gap-2">
                    ...
                    <p className="text-blue-950/60 text-sm font-medium">Loading records...</p>
                </div>
            ) : classes.length === 0 ? (
...
>
                                        ...
                                        <Table.Row key={item._id}>
                                            <Table.Cell>
                                                <div className="flex items-center gap-4">
                                                    <img src={item.image || "/placeholder.jpg"} alt="" className="w-12 h-12 rounded-lg object-cover border border-blue-100 bg-blue-50 flex-shrink-0" />
                                                    <div>
                                                        <span className="font-bold text-blue-950 block line-clamp-1">{item.className}</span>
                                                        <span className="text-xs text-blue-400 font-semibold">Price: ${item.price}</span>
                                                    </div>
                                                </div>
                                            </Table.Cell>
                                            <Table.Cell><Chip size="sm" variant="flat" className="bg-blue-50 border border-blue-100 text-blue-950 font-medium">{item.category}</Chip></Table.Cell>
                                            <Table.Cell><div className="flex items-center gap-1"><Clock size={14} className="text-blue-400" />{item.duration}</div></Table.Cell>
                                            <Table.Cell>
                                            ...
                                            <Table.Cell>
                                                <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <Button size="sm" isIconOnly variant="flat" onClick={() => handleOpenDelete(item._id)} className="bg-red-50 text-red-600 hover:bg-red-100">
                                                        <Trash2 size={15} />
                                                    </Button>
                                                </div>
                                            </Table.Cell>
                                            ...
                                            <div key={i} className="flex items-center justify-between p-3 border border-blue-100 rounded-xl bg-blue-50/30">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-blue-400 font-medium flex items-center gap-1"><Mail size={12} /> {student.userEmail}</p>
                                                    </div>
                                                </div>
                                                <span className="text-xs font-semibold text-blue-500 bg-white border border-blue-100 rounded-md px-2 py-1">
    ...
    />
                            ...
                            <Modal.Footer className="border-t border-blue-100 px-6 py-4 bg-gray-50 flex justify-end gap-3">
                                <Button size="md" variant="light" className="text-blue-900 font-bold hover:bg-blue-50 rounded-xl" onClick={() => setModals(prev => ({ ...prev, edit: false }))}>Cancel</Button>
                                <Button
                ...
                <Modal.Backdrop className="bg-red-950/20 backdrop-blur-sm">
                    <Modal.Container>
                        ...
                        >
                            ...
                            <Modal.Body className="py-4">
                                <p className="text-blue-950 text-sm font-medium leading-relaxed">Are you absolutely sure you want to remove this class template? This operation is permanent and cannot be undone.</p>
                            </Modal.Body>
                            <Modal.Footer className="border-t border-red-50 pt-4 flex gap-3">
                                <Button size="md" variant="light" className="text-blue-950 font-bold rounded-xl flex-1" onClick={() => setModals(prev => ({ ...prev, delete: false }))}>Abort</Button>
                                <Button size="md" isLoading={submitting} className="bg-red-600 text-white font-bold rounded-xl flex-1 hover:bg-red-700 transition" onClick={handleDeleteConfirm}>Delete Permanently</Button>
                            </Modal.Footer>
                        </Modal.Dialog>
                    </Modal.Container>
                </Modal.Backdrop>
