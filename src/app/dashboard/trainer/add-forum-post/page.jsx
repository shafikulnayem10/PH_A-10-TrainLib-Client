...
import { createForumPostAction } from "@/lib/actions/trainer";
            ...
            <Card className="border border-blue-100 shadow-xl shadow-blue-100/40 rounded-3xl bg-white p-8 max-w-full">
                <form onSubmit={handleSubmit} className="space-y-6 w-full">
                    ...
                    <div className="w-full">
                        ...
                        <Input
                            placeholder="e.g., The Importance of Proper Warm-up in Fitness"
                    ...
                    <div className="w-full">
                        ...
                        <TextArea
                            placeholder="Write a detailed description about your topic, share insights, tips, and valuable information..."
                            minRows={8}
                            maxRows={15}
