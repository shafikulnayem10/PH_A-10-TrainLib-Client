...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-slate-900 dark:bg-slate-950 border-t border-slate-800 dark:border-slate-900 text-slate-300 dark:text-slate-400 mt-auto transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        
        {/* Main Footer Content Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-slate-800 dark:border-slate-900">
          
          {/* Column 1: Brand & Description */}
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-slate-700/60 bg-slate-800 shadow-sm overflow-hidden">
                <Image
                  src={logoImg}
                  alt="TrainLib Logo"
                  fill
              ...
              <h1 className="text-xl font-black text-white tracking-tight">
                Train<span className="text-blue-400">Lib</span>
              </h1>
            </Link>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li className="flex items-center gap-3 text-sm font-medium text-slate-300">
                ...
                <a href="tel:+880123456789" className="hover:text-blue-400 hover:underline transition-colors">
                  +880 1234-567890
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm font-medium text-slate-300">
                <Mail size={16} className="text-blue-400 shrink-0" />
                <a href="mailto:support@trainlib.com" className="hover:text-blue-400 hover:underline transition-colors">
          ...
          <div className="flex items-center gap-3 order-1 sm:order-2">
            {socialLinks.map((social) => (
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-800 border border-slate-700 text-slate-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 shadow-sm transition-all duration-200 hover:-translate-y-0.5"
              >
                {social.icon}
              </a>
            ))}
